 ...
 *
 * Ejemplo de uso para multiplicación de matrices:
 * \code
 ...
 * Asigna el puntero a la función matriz_producto en el campo product de la API.
 *
 ...
 * \enddot
 *
 * El algoritmo implementado es:
 * 1. Validar punteros de entrada
 * 2. Verificar compatibilidad de dimensiones
 * 3. Si las dimensiones no son compatibles, llenar M3 con ceros
 * 4. Si son compatibles, calcular el producto matricial usando tres bucles anidados
